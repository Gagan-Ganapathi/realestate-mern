...
export default function UpdateListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (+formData.regularPrice < +formData.discountPrice)   //Unary Plus (+) Operator: The unary plus operator attempts to convert its operand into a number. If the operand is not already a number, it will try to convert it.
